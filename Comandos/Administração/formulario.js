  ...
  run: async (client, interaction) => {
    ...
    if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.Administrator)) {
        ...
        if (canal_formulario.type !== Discord.ChannelType.GuildText) {
            ...
            let a = interaction.guild.iconURL({ dynamic: true });
            let b = '```Recrutamento```'
            ...
            interaction.reply({ embeds: [embed], ephemeral: true }).then( () => {
                ...
                .setImage(`https://media.discordapp.net/attachments/1225892797102424064/1227297988758470728/aaaaaaa.png?ex=6627e552&is=66157052&hm=7fd8256bd7923fda498a68a170325f9e67425d137732b8582080b6e7718962ba&=&format=webp&quality=lossless`)
                .setTitle(`Recrutamento | Nobre`)
                .setDescription(`Clique no botão abaixo para fazer parte da melhor facção da cidade!`);
